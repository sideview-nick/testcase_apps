...
class aTestHandler(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        ...
        response_dict["payload"] = {
            ...
            "sys.path" : sys.path,
            "which_foo": foo.provenance(),              # bad
            "which_bar": bar.provenance(),              # good
            "which_baz_inside_bar": bar.secondary_provenance(),  #bad
            "splunklib_version" : splunklib.__version__,  #bad
            "which_splunklib":  splunklib.__random_property__  #bad
        }
